...
<html lang="en">
  <head>
    ...
    <title>私房咖啡豆-水果調性</title>

    <link href="../assets/css/fruit.css" rel="stylesheet">
            ...
            <div class="boutique_box">
                <div class="one">
                    ...
                    <ul class="coffee_choose_menu">
                        ...
                        <li><a href="fruit.jsp"><h3>私房咖啡豆-水果調性</h3></a>
                        </li>
			...
			try {	// 例外處理
				...
				if(con.isClosed()) // con.isClosed() 回傳 ture 代表連線關閉
				   out.println("警告：連線建立失敗！"); // 連線關閉代表連線沒有被建立
					...
					sql="select * from `coffee` where `product_id` like 'A%' && `product_aroma` like '水果%'"; // SQL 語法：取得 counter 資料表中的所有資料
