...
<html lang="en">
  <head>
    ...
    <title>私房咖啡豆-花香調性</title>

    <link href="../assets/css/flower.css" rel="stylesheet">
            ...
            <div class="boutique_box">
                <div class="one">
                    ...
                    <ul class="coffee_choose_menu">
                        ...
                        <li><a href="wood.jsp">私房咖啡豆-木質調性</a>
                        </li>
                        <li><a href="fruit.jsp">私房咖啡豆-水果調性</a>
                        </li>
                        <li><a href="flower.jsp"><h3>私房咖啡豆-花香調性</h3></a>
                        </li>
                    </ul>
			...
			try {	// 例外處理
				...
				if(con.isClosed()) // con.isClosed() 回傳 ture 代表連線關閉
				   out.println("警告：連線建立失敗！"); // 連線關閉代表連線沒有被建立
					...
					sql="select * from `coffee` where `product_id` like 'A%' && `product_aroma` like '花香%'"; // SQL 語法：取得 counter 資料表中的所有資料
