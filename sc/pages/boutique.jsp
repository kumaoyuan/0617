...
<html lang="en">
  <head>
   ...
   <form method="get" action="product.jsp">
    ...
    <link href="../assets/css/boutique.css" rel="stylesheet">
			...
			<div class="boutique_box">
                <div class="one">
                    <ul class="coffee_choose_menu">
                        <li><a href="boutique.jsp"><h3>精品咖啡豆</h3></a>
                        </li>                      
			...
			try {	// 例外處理
				...
				if(con.isClosed()) // con.isClosed() 回傳 ture 代表連線關閉
				   out.println("警告：連線建立失敗！"); // 連線關閉代表連線沒有被建立
					...
					sql="select * from `coffee` where `product_id` like 'B%'"; // SQL 語法：取得 counter 資料表中的所有資料
